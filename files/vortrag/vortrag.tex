...
\usepackage{ae}
\usepackage{amsmath}  		  % fï¿½r erw. Formeloptionen, Option [] zur Vermeidung von Type3-Fonts
\usepackage{amstext}          % fï¿½r Klartext via \text{} in Formeln
\usepackage{amsfonts}         % fï¿½r komplexere Formeln (Mengensymbole ...)
\usepackage{amssymb}          % fï¿½r komplexere Formeln (Mengensymbole ...)
\usepackage{graphicx} 		  % Einbindung von Grafiken (pdf, png, jpg)
\usepackage{dsfont}
\usepackage{bm} 
\usepackage{mathrsfs}
\usepackage{setspace}
\usepackage{enumerate}        % verbessert Aufzï¿½hlungen
\usepackage{array}            % fï¿½r Tabellen: bindet tabular-Umgebung ein
...
\begin{frame}\frametitle{Elternselektion detailiert} 
	...
	\only<3-4>{\put(60,0){\includegraphics[width=0.7\linewidth]{abbildungen/detParSel2.png}}}%	
	
	\only<1->{\put(0,160){\parbox{8cm}{\Large \textbf{Deterministische Selektion:}}}}%
	...
	\only<3-4>{\put(165, 135){\parbox{4cm}{\textbf{Fitness}}}}%
	\only<3-4>{\put(70, 142){\parbox{4cm}{besser}}}%
	\only<3-4>{\put(250, 142){\parbox{4cm}{schlechter}}}%
	\only<4>{\put(230, 45){\parbox{4cm}{\textbf{Gruppe der\newline Besten}}}}%
	\only<4>{\put(230, 5){\parbox{4cm}{\textbf{Zufallsauswahl}}}}%
	\end{picture}%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%    Ergebnisse altersabhï¿½ngige Mutationsrate     %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
