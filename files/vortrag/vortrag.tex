...
\begin{frame}\frametitle{Darstellung eines Evolutionszyklus (n = 2)} 
	\begin{minipage}{0.7\linewidth}
		\includegraphics[width=8.5cm]{abbildungen/mutationsrate.pdf}
	\end{minipage}
	\begin{minipage}[t]{0.28\linewidth}
	\textbf{Parameter:}
	\begin{itemize}
	\item $p_\text{rr} = 1$ \\
	(rangbasierte Elternselektion)\\[-0.75cm]
	\end{itemize}
	\end{minipage}
\end{frame}

% Framebeginn...%
\begin{frame}\frametitle{Ausführliche Darstellung Fitness bei variablem $p_\text{rr}$ für $n = 2$} 
	\centering
	\includegraphics[width=10cm]{abbildungen/mutationsrate.pdf}
\end{frame}

% Framebeginn...%
\begin{frame}\frametitle{Fitness für abnehmende Mutationsrate bei variablem $p_\text{rr}$} 
	\centering
	\includegraphics[width=10cm]{abbildungen/mutationsrate.pdf}
\end{frame}

% Framebeginn...%
\begin{frame}\frametitle{Fitness für konstante Mutationsrate bei variablem $p_\text{rr}$} 
	\centering
	\includegraphics[width=10cm]{abbildungen/mutationsrate.pdf}
\end{frame}

% Framebeginn...%
\begin{frame}\frametitle{Fitness für zunehmende Mutationsrate bei variablem $p_\text{rr}$} 
	\centering
	\includegraphics[width=10cm]{abbildungen/mutationsrate.pdf}
\end{frame}

% Framebeginn...%
\begin{frame}\frametitle{Vergleich der Mutationsarten für $n = 2$} 
	\centering
	\includegraphics[width=10cm]{abbildungen/mutationsrate.pdf}
\end{frame}

% Framebeginn...%
\begin{frame}\frametitle{Vergleich der Mutationsarten für $n = 32$} 
	\centering
	\includegraphics[width=10cm]{abbildungen/mutationsrate.pdf}
\end{frame}
...
% Framebeginn...%
	...
	\begin{itemize}
		\item Algorithmus liefert $\mathbf{n \leq 4}$ \textbf{sehr gute} Ergebnisse ($F < 0.04$) und für $\mathbf{n>4}$ \textbf{durchschnittliche} Ergebnisse ($F < 1$)

		\item es existiert \textbf{immer ein optimales Verhältnis} zwischen rangbasierter und zufälliger Elternselektion:
			\begin{enumerate}
				\item[(1)] abnehmend Mutationsrate $\longrightarrow$ $p_\text{rr} = $
				\item[(2)] abnehmend Mutationsrate $\longrightarrow$ $p_\text{rr} = $
				\item[(3)] abnehmend Mutationsrate $\longrightarrow$ $p_\text{rr} = $
			\end{enumerate}
		
		\item für $n \leq 4$ zunehmende Mutationsrate, für $n>4$ abnehmende Mutationsrate am genauesten
