...
\begin{frame}\frametitle{Fragestellungen} 
    ...
    \begin{enumerate}
	\item[(1)]<1-> Welchen Einfluss hat das Elternauswahlverhältnis $p_\text{rr}$ auf die Güte des evolutionären Algorithmus?\\[0.75cm]
	\item[(2)]<2> Welchen Einfluss hat die (zeitabhängige) Mutationsrate $m(a)$ auf die Güte des evolutionären Algorithmus?	
    \end{enumerate}
\end{frame}
...
% Framebeginn...%
\begin{frame}\frametitle{Fitness bei variablem $p_\text{rr}$ für $n = 4$} 
...
% Framebeginn...%
\begin{frame}\frametitle{Durchschnittliche Fitness für konstante Mutationsrate} 
	\centering
	\includegraphics[width=10cm]{abbildungen/constant_allDim_average.pdf}
\end{frame}

% Framebeginn...%
\begin{frame}\frametitle{Durchschnittliche Fitness für zunehmende Mutationsrate} 
	\centering
	\includegraphics[width=10cm]{abbildungen/increasing_allDim_average.pdf}
\end{frame}

% Framebeginn...%
\begin{frame}\frametitle{Vergleich beider Mutationsarten für $n = 4$} 
	\centering
	\includegraphics[width=10cm]{abbildungen/vergleich_mutationsraten_n4.pdf}
\end{frame}

% Framebeginn...%
\begin{frame}\frametitle{Vergleich beider Mutationsarten für $n = 32$} 
	\centering
...
\begin{frame}\frametitle{Zusammenfassung}
	\begin{itemize}
		\item Algorithmus liefert $\mathbf{n \leq 4}$ \textbf{gute} Ergebnisse ($F < 0.2$) und für $\mathbf{n>4}$ \textbf{mindestens durchschnittliche} Ergebnisse ($F < 1$)
		\item \textbf{konstante} Mutationsrate $\longrightarrow$ \textbf{kaum Variation} bzgl. $p_\text{rr}$ für alle Dimensionen durch mangelnde Diversität 
		\item \textbf{zunehmende} Mutationsrate $\longrightarrow$ \textbf{signifikant bessere} Ergebnisse für $p_\text{rr} > 0.2$ durch hohe Diversität 
...
\backupbegin
\section{Optimierung}
\begin{frame}<presentation:1>\frametitle{Mögliche Optimierungen}
	\begin{itemize}
		\item Erhöhung der Populationgröße
		\item Vergrößerung der Kindpopulation
		\item ``Mutationsstärke'' nicht gleichverteilt sondern normalverteilt 
