...
% Framebeginn...%
	...
	\begin{itemize}
		...
		\item \textbf{zunehmende} Mutationsrate $\longrightarrow$ \textbf{signifikant bessere} Ergebnisse für $p_\text{rr} \lesssim 1$ durch hohe Diversität 
		\item zunehmende Mutationsrate mit $p_\text{rr} \approx 0.8$ am genauesten
