...
% Framebeginn...%
	...
	\begin{itemize}
		...
		\item \textbf{abnehmende} Mutationsrate $longrightarrow$ \textbf{kaum Variation} bzgl. $p_\text{rr}$ durch mangelnde Diversität 
		\item \textbf{konstante} Mutationsrate $longrightarrow$ \textbf{kaum Variation} bzgl. $p_\text{rr}$ durch mangelnde Diversität 
		\item \textbf{zunehmende} Mutationsrate $longrightarrow$ \textbf{signifikant bessere} Ergebnisse für $p_\text{rr}$ nahe 1 durch hohe Diversität 
		
		\item zunehmende Mutationsrate mit $p_\text{rr} \geq 0.8$ am genauesten
